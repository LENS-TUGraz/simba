...
(directly coupled) Botoks using it's original KXOB-25 solar panel (pre-recorded IV curve).
...
panels = ['KXOB25-02-X8F', 'AM1417'] #Select types of solar panels 
...
label_start = 0.88
label_height = 0.07
top = label_start + 2* label_height + 0.05
...
hspace=0.2,
wspace=0.2)
fig.savefig("BotoksPVCurveOriginal.pdf")
